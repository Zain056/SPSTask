...
<head>
    <meta charset="UTF-8">
    <title>MVC Secure Registration</title>
    <style>
...
<div class="form-container">
    <h2 style="text-align: center;">MVC Registration</h2>
    
    <!-- Printing values sent from the Controller -->
    <?php if(!empty($message)) echo $message; ?>

    <form method="POST" action="index.php">
        <!-- CSRF Fix Step 3: Inject token into HTML form as a hidden input field -->
